document.addEventListener('DOMContentLoaded', function() {
    ...
    // Variables
    let reuniones = JSON.parse(localStorage.getItem('videoconferencias_edomex')) || [];
    ...
    function init() {
        ...
        // Cargar fecha actual en el filtro
    ...
    function guardarReuniones() {
        localStorage.setItem('videoconferencias_edomex', JSON.stringify(reuniones));
