...
// =============================================
const EMAILJS_USER_ID = '5pe5riPrvzZHMFE3N'; // Reemplaza con tu User ID
const EMAILJS_SERVICE_ID = 'service_5h1121k'; // Reemplaza con tu Service ID
const EMAILJS_TEMPLATE_ID = 'template_r1y2nzw'; // Reemplaza con tu Template ID
...
async function enviarCorreoNuevaReunion(reunionData) {
    try {
        ...
        const templateParams = {
            ...
            estado: formatearEstado(reunionData.estado)
        };
...
async function guardarDatos(reunionData) {
    try {
        ...
        // ENVIAR CORREO SOLO PARA NUEVAS REUNIONES (NO PARA EDICIONES)
        if (!reunionEditando) {
